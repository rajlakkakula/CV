...
%1844 10th St. N.    & Phone: (701) 231-6642 \\
...
%& Web : \href{https://plakkakula.github.io}{plakkakula.github.io}\\
%& GitHub : \href{https://github.com/plakkakula}{github.com/plakkakula}
%1770 10th ST. N, Apt. 221 \\
%Fargo, ND, 58102 & {Website:}
%\url{prithvi.com}
\end{tabular}
...
%Doctor of Philosophy (Ph.D.) in Food and Resource Economics \hfill %(GPA 3.79/4.0)
...
%{\bf Acharya N.G Ranga Agricultural University}, Hyderabad, India \hfill August 2007 \\
%Bachelor of Science (B.Sc.) in Agriculture \hfill %(GPA 3.32/4.0)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sc Editorial Position}
%%%%%%%%%

%{\bf Research Assistant Professor} \hfill{November 2020 -- } \\
...
%{\bf Production Trainee} \hfill{April 2008 -- July 2008} \\
%Pioneer Hyderabad India (PHI) Seeds, Limited \\
%Hyderabad, India. 
...
\end{etaremune}
%\newpage
%{\bf Manuscripts/Book Chapters Under Review}
%\\
%\begin{list2}
%\item Schmitz, A., and {\bf Lakkakula, P}. (2021). \say{Distributional Effects of Sugar Tax Policy}. Revised and Resubmitted in {\em Journal of Public Health}.

%\item {\bf Lakkakula, P}., and Wilson, W. (2021). \say{How Blockchain Technology Impact Agriculture}. Revised and Resubmitted for the {\em Handbook on Blockchain and Cryptocurrencies}. Edward Elgar Publishing. 

%\item {\bf Lakkakula, P}., and Wilson, W. (2019). \say{Origin and Destination Basis Interdependencies in Soybeans: A Panel Data Analysis}. Under Review in {\em Journal of Agricultural Resource Economics.}
%\item {\bf Lakkakula, P}. (2018). \say{Time Series Versus Causal Forecasting: An Application of Artificial Neural Networks}. Under Review in {\em International Conference on Time Series and Forecasting}.
%\item {\bf Lakkakula, P}. (2018). \say{Impact of Sweetener Input Tax on Public Health}. Under Review in {\em Applied Health Economics and Health Policy}.
%\item {\bf Lakkakula, P}., and Olson, F. (2017). \say{NAFTA Renegotiation: Potential Issues Related to Sweeteners}. {\em Choices}.
%\item {\bf Lakkakula, P}. (2016). "Causal Vs Time Series Neural Networks: Which Method Forecasts Better?". {\em Agribusiness: An International Journal}
%\item {\bf Lakkakula, P}., Schmitz, A., and Manhong, Z. (2017). \say{US Sweeteners: Combating Excess Consumption with an Excise Tax?}. At Revise and Resubmit stage in {\em Food Policy.}
%\item {\bf Lakkakula, P}. (2017). \say{Testing Causality Among Five Fertilizer Prices}. Under Review in {\em Applied Economics Letters} 
%\item {\bf Lakkakula, P}., and Ripplinger, D. (2017). \say{Forecasting U.S. High Fructose Corn Syrup Prices}. Under Review in {\em International Sugar Journal}
%\end{list2}


%{\bf Manuscripts ready for submission}
%\\
%\begin{list2}
%\item {\bf Lakkakula, P}. (2016). "Causal Vs Time Series Neural Networks: Which Method Forecasts Better?". Target Journal: {\em Econometric Reviews} 
%\item {\bf Lakkakula, P}. (2016). "Testing Causality Among Five Fertilizer Prices". Target Journal: {\em Applied Economics Letters} 
%\end{list2}
%\newpage
...
\\
\begin{list2}
%\item Schmitz, A., and {\bf Lakkakula, P} (2020). \say{Distributional Effects of Sugar Tax Policy}. Target Journal: {\em Applied Health Economics and Health Policy}. 
...
%\item Bullock, D. W., Wilson, W. W., and {\bf Lakkakula, P}. (2022). \say{Short-Term Dynamics and Structural Changes in the U.S. and Brazil Soybean Basis: Seasonality, Volatility, Structural Breaks and Information Flows}. Target Journal: {\em Journal of Commodity Markets},
%\item  Olson, F., {\bf Lakkakula, P}., and Schweiss, K. (2021). \say{The Impact of Business Unit Mix and Firm Size on Cooperative Financial Performance}. Target Journal: {\em Agricultural Finance Review.}
%\item {\bf Lakkakula, P}., Schmitz, T., and Wahl, T. (2020). \say{Welfare Analysis of Sweetener Trade between the United States and Mexico}. Target Journal: {\em American Journal of Agricultural Economics.}
...
%\item {\bf Lakkakula, P}., Wilson, W.W., and Bullock, D. (2021). Evaluating the Dynamic Factors of Soybean Basis From Four Locations. 
%\item {\bf Lakkakula, P}., \& Gold, A. (2018). \say{Strategies and Challenges in Successful Implementation of SSB/Soda Tax}. Target Journal: {\em Public Health Nutrition} 
%\item {\bf Lakkakula, P}., Bullock, D., \& Wilson, W. (2019).\say{Applications of Blockchain Technology in Agriculture.} Target Journal: {\em Journal of Private Enterprise}.
%\item Wahl, T., May, S., \& {\bf Lakkakula, P}. (2020). \say{The Export/Import Process and Streamlining Trade}. Target Journal: {\em Journal of Private Enterprise.}
%\item {\bf Lakkakula, P}. (2018). \say{Testing Change in Consumer Preferences Between Sugar and High Fructose Corn Syrup Markets}. Target Journal: {\em Applied Economics.}
%\item {\bf Lakkakula, P}., and Olson, F. (2018). \say{Dynamic Long-Run Relationships and Price Transmission Among Five Fertilizer Prices}. Target Journal: {\em Agribusiness: An International Journal.} 

%\item  Olson, F., and {\bf Lakkakula, P}. (2020). \say{Panel Data Analysis of Agricultural Cooperatives in the Midwest}. Target Journal: {\em Agricultural Finance Review.}
%\item {\bf Lakkakula, P}., Wilson, W., and Bullock, D. (2020). \say{Asymmetric Information in International Grain Trading: Role of Blockchain Technology}. Target Journal: {\em Applied Economic Perspectives and Policy.}
\end{list2}

%%%%%%%%%%%%%%%%%%%%%%%%%
%\section{\sc Book Chapters}
%Lakkakula, P., Haynes, D.J. and Schmitz, T.G. (2015). "Genetic Engineering and Food Security: A Welfare Economics Perspective". \textit{Food Security in an Uncertain World (Frontiers of Economics and Globalization)}, Volume 15, Emerald Group Publishing Limited, 15, pp. 179--193.
%\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
(2018). \say{Potential Effects of the Additional Duties Imposed by India on U.S. Chickpeas and Lentils}. Research Report. %\href{https://ageconsearch.umn.edu/record/266444/files/Final%20Research%20Report_PEA%20AND%20LENTIAL%20MARKET%20ANALYSIS_Lakkakula%20et%20al%202017-1.pdf}{\say {Pea and Lentil Market Analysis}}. Research Report Submitted To
...
%\item Presented a seminar titled \textit{Sales and Personal Selling} at Sam Houston State University, Huntsville, TX, May 7, 2018.
...
%\begin{list2}
%\item Agricultural and Applied Economics Association (AAEA)
%\item American Economic Association (AEA)
%\item Southern Agricultural Economics Association (SAEA)
%\item Institute of Food Technologists' (IFT) Association 
%\end{list2}
...
%\item \href{https://agfax.com/2016/12/06/farming-and-big-data-dont-confuse-it-with-precision-agriculture/}{\say{Farming and Big Data: Don’t Confuse it with Precision Agriculture.}} \textit{Agfax.}
...
PRECISIONheor\\
%A precision value and health team\\
Los Angeles, California \\
Cell: 813-505-9027\\
Email: Dwayne.Haynes@precisionvh.com
...
%David W. Bullock \\%(Relationship: Ph.D. supervisor and collaborator)\\
%Research Associate Professor\\
%Dept. of Agribusiness and Applied Economics\\
%North Dakota State University\\
%Fargo, North Dakota\\
%Phone: 701-231-8672\\
%Email: david.w.bullock@ndsu.edu
%\switchcolumn
%
%   Andrew Schmitz\\
